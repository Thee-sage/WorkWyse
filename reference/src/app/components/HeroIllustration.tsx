...
export function HeroIllustration() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Background layer — job listing document */}
        <motion.g style={{ x: bgX, y: bgY }}>
          ...
          {/* Warning highlight on suspicious line — draws on load */}
          <motion.rect
            x="101" y="145" width="180" height="14" rx="2" fill="#E5484D" opacity="0.07"
            initial={{ width: 0 }}
            animate={{ width: 180 }}
            transition={{ duration: 0.6, delay: 1.0, ease: "easeOut" }}
          />
          <motion.line
            x1="101" y1="159" x2="281" y2="159" stroke="#E5484D" strokeWidth="1.5" strokeLinecap="round" opacity="0.35"
            initial={{ pathLength: 0 }}
            animate={{ pathLength: 1 }}
            transition={{ duration: 0.5, delay: 1.2, ease: "easeOut" }}
          />

          {/* Second highlight on another line */}
          <motion.rect
            x="101" y="169" width="130" height="14" rx="2" fill="#E5484D" opacity="0.05"
            initial={{ width: 0 }}
            animate={{ width: 130 }}
            transition={{ duration: 0.5, delay: 1.4, ease: "easeOut" }}
          />

          {/* Salary section — looks suspicious */}
          ...
          {/* "Apply Now" button — greyed out / suspicious */}
          ...
          {/* Date posted — old date */}
          <rect x="105" y="290" width="100" height="5" rx="2" fill="#1A1A1A" opacity="0.06" />
          <text x="108" y="310" fill="#1A1A1A" fontSize="6.5" fontFamily="Inter, sans-serif" opacity="0.25">Posted: Aug 2024</text>

          {/* Pencil marks */}
          <path d="M 95 330 L 100 328 L 103 332" stroke="#1A1A1A" strokeWidth="1" fill="none" opacity="0.2" strokeLinecap="round" />
          <path d="M 335 350 L 340 347 L 343 352" stroke="#1A1A1A" strokeWidth="1" fill="none" opacity="0.2" strokeLinecap="round" />
        </motion.g>

        {/* Foreground layer — stamps, annotations, magnifying glass */}
        <motion.g style={{ x: fgX, y: fgY }}>
          {/* GHOST JOB stamp */}
          <motion.g
            transform="translate(285, 180) rotate(-8)"
          ...
          >
            ...
            <text x="0" y="1" textAnchor="middle" fill="#E5484D" fontSize="11" fontFamily="'Playfair Display', serif" fontWeight="600" dominantBaseline="middle">
              GHOST JOB
            </text>
            <text x="0" y="14" textAnchor="middle" fill="#E5484D" fontSize="7" fontFamily="Inter, sans-serif" opacity="0.6" dominantBaseline="middle">
              FLAGGED
            </text>
          </motion.g>

          {/* Community verification seal */}
          <motion.g
            transform="translate(155, 330)"
          ...
          >
            ...
            <text x="0" y="-4" textAnchor="middle" fill="#2F6F5E" fontSize="7" fontFamily="Inter, sans-serif" fontWeight="600" dominantBaseline="middle">
              COMMUNITY
            </text>
            <text x="0" y="7" textAnchor="middle" fill="#2F6F5E" fontSize="7" fontFamily="Inter, sans-serif" fontWeight="600" dominantBaseline="middle">
              VERIFIED
            </text>
          </motion.g>

          {/* Community annotation note */}
          <motion.g
            transform="translate(320, 70) rotate(3)"
          ...
          {/* Annotation arrow pointing to highlighted text */}
          <motion.path
            d="M 72 100 C 82 120, 90 135, 100 145"
